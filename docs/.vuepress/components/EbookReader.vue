<template>
    <div class="ebook-reader">
        <!-- 未加载书籍时的提示 -->
        <div v-if="!bookLoaded" class="empty-state">
            <div class="empty-content">
                ...
                <p class="subtitle">请前往 <a href="/articles/?tab=ebooks">文章管理</a> 选择要阅读的书籍</p>
            </div>
        </div>
            ...
            <div class="reader-toolbar">
                <div class="toolbar-content-wrapper">
                    ...
                    <div class="toolbar-right">
                        ...
                        <button class="toolbar-btn close-btn" @click="closeBook" title="关闭书籍">
                            <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
import { useVocabulary } from '../plugins/bilingual-pack/client/composables/useVocabulary'
import { useSentenceBank } from '../plugins/bilingual-pack/client/composables/useSentenceBank'
import AnnotationForm from '../plugins/bilingual-pack/client/components/AnnotationForm.vue'
